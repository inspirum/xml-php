...
class BasicTest extends AbstractTestCase
{
    ...
    public function testReaderWithEmptyFilepath()
    {
    ...
    public function testReaderWithNonExistingFilepath()
    {
        $this->expectException(Exception::class);
    ...
    public function testReaderNextNodeNotExists()
    {
    ...
    public function testReaderNextNode()
    {
        $reader = new XMLReader($this->getSampleFilepath('sample_04.xml'));
    ...
    public function testReaderNextNodeEmpty()
    {
        $reader = new XMLReader($this->getSampleFilepath('sample_04.xml'));
    ...
    public function testReaderNextNodeEmpty2()
    {
        $reader = new XMLReader($this->getSampleFilepath('sample_04.xml'));
    ...
    public function testReaderIterateOverNode()
    {
        $reader = new XMLReader($this->getSampleFilepath('sample_04.xml'));
    ...
    public function testReaderIterateOverNamespacedNode()
    {
    ...
    public function testReaderUsageNode()
    {
        $reader = new XMLReader($this->getSampleFilepath('sample_04.xml'));
